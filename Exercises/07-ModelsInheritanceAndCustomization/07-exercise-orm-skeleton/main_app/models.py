...
class Message(models.Model):
    ...
    def forward_message(self, sender, receiver):
        new_message = Message.objects.create(sender=sender, receiver=receiver, content=self.content)
        return new_message
...
class BaseReservation(models.Model):
    ...
    def calculate_total_cost(self):
        return round(self.room.price_per_night * self.reservation_period(), 1)
